...
func TestParseCurrency_Success(t *testing.T) {
	tt := map[string]struct {
		...
		"hundredth EUR": {
			in: "EUR", expected: Currency{code: "EUR", precision: 2},
		},
		"thousandth BHD": {
			in: "BHD", expected: Currency{code: "BHD", precision: 3},
		},
		"tenth VND": {
			in: "VND", expected: Currency{code: "VND", precision: 1},
		},
		"integer IRR": {
			in: "IRR", expected: Currency{code: "IRR", precision: 0},
		},
	}
